...
set val(cp)					"cbr30node.tcl"			    ;#<-- traffic file
set val(sc)					"setdest30node.tcl"			;#<-- mobility file 
...
set val(tx_power)           0.33                        ;# 80% 0.8energy consume for transmiting packet
...
set tracefd     [open result30node.tr w]
set namtrace    [open result30node.nam w]
